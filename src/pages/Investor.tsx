      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">
            Investor & Mentor Overview
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            CareRoam is currently seeking validation, partnerships, mentors, and strategic guidance.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-care-600 to-care-800 rounded-2xl p-6 sm:p-8 text-white mb-10 shadow-xl">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div className="flex-1">
              <p className="font-semibold text-lg mb-1">Current Stage: Validation & Implementation</p>
              <p className="text-care-200 text-sm">
                We have a working prototype and are actively seeking hospital partnerships, 
                traveler feedback, and strategic guidance to move toward pilot launch.
              </p>
            </div>
            <Link
              to="/waitlist"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              To make trusted healthcare accessible for every traveler in India, 
              eliminating the anxiety of finding quality medical care away from home.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Travelers in India struggle to find trusted healthcare during emergencies. 
              Unknown hospitals, language barriers, and lack of verified information lead to 
              delayed or poor care decisions. Hotels and travel agencies lack infrastructure 
              to guide guests to reliable medical help.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-8">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-3">Market Opportunity</h2>
            <ul className="space-y-3">
              {[
                'India\'s healthcare market: ₹30+ Lakh Crore and growing rapidly',
                '500M+ domestic trips taken annually in India',
                '2.2M+ hospital beds across 70,000+ hospitals',
                'Medical tourism in India projected to exceed ₹1 Lakh Crore by 2026',
                'Growing digital health adoption post-pandemic',
              ].map((item, i) => (
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-8">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-3">Current Stage</h2>
            <div className="space-y-4">
              <div>
                <p className="text-sm font-semibold text-gray-900 mb-2">✅ Completed</p>
                <ul className="space-y-1.5">
                  {[
                    'Working prototype built (React + Tailwind)',
                    'Conducted 12 validation interviews with travelers',
                    'AI Health Assistant prototype functional',
                    'Emergency contacts database compiled',
                    'Multi-language phrase translator built',
                  ].map((item, i) => (
              ...
              <div>
                <p className="text-sm font-semibold text-gray-900 mb-2">🔄 In Progress</p>
                <ul className="space-y-1.5">
                  {[
                    'Scaling validation interviews (target: 50)',
                    'Hospital partnership outreach in Mumbai',
                    'Building investor pitch deck and financial model',
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-8 mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              { title: 'Mentorship', desc: 'Share your expertise in healthcare, travel, or startup operations', icon: Lightbulb, action: 'Become a Mentor', link: '/feedback' },
              { title: 'Partnerships', desc: 'Connect us with hospitals, hotel chains, or travel agencies', icon: Building2, action: 'Introduce Us', link: '/partner' },
              { title: 'Investment', desc: 'Join our pre-seed round or introduce us to angel investors', icon: TrendingUp, action: 'Get in Touch', link: '/feedback' },
            ].map((item) => {
              const Icon = item.icon;
              return (
                <div key={item.title} className="text-center p-6 rounded-xl border border-gray-100 hover:border-care-200 hover:shadow-sm transition-all">
        ...
        <div className="text-center bg-gradient-to-br from-care-50 to-blue-50 rounded-2xl border border-care-200 p-8">
          ...
          <p className="text-gray-600 max-w-lg mx-auto mb-6">
            We're always open to connecting with potential mentors, partners, and investors 
            who share our vision of making travel healthcare accessible.
          </p>
