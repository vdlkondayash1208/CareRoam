...
type PartnerType = 'hospital' | 'hotel' | 'travel-agency';
...
const partnerTypes: { type: PartnerType; icon: typeof Hospital; label: string; description: string; color: string }[] = [
  { type: 'hospital', icon: Hospital, label: 'Hospital / Clinic', description: 'Register interest to join CareRoam\'s verified provider network', color: 'from-red-500 to-red-600' },
  { type: 'hotel', icon: Hotel, label: 'Hotel / Resort', description: 'Partner with us to offer healthcare concierge for your guests', color: 'from-green-500 to-emerald-600' },
  { type: 'travel-agency', icon: Briefcase, label: 'Travel Agency', description: 'Collaborate to provide health resources for your travelers', color: 'from-purple-500 to-pink-600' },
];
...
export default function PartnerDashboard() {
  ...
  const updateForm = (field: keyof PartnerForm, value: string) => {
      ...
      <div className="min-h-screen pt-20 bg-gray-50">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="bg-white rounded-3xl border border-gray-200 shadow-xl p-8 sm:p-12 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Interest Registered!</h2>
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              Thank you for expressing interest in partnering with CareRoam. 
              We're currently in validation phase and will reach out as we expand our network. 
              Your input helps us understand what providers need.
            </p>
            <button
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-50 border border-amber-200 text-amber-700 text-xs font-medium mb-4">
            ...
            Partnership Interest — Validation Stage
          </span>
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">Partner With Us</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            CareRoam is building a trusted healthcare network for travelers. 
            Register your interest below — we'll reach out as we expand to your city.
          </p>
        </div>
              ...
              <div className="px-6 py-4 border-b border-gray-100 bg-gray-50">
                <div className="flex items-center justify-between">
                  <h2 className="text-lg font-semibold text-gray-900">
                    {form.type === 'hospital' ? 'Hospital / Clinic Interest' : 
                     form.type === 'hotel' ? 'Hotel / Resort Interest' : 
                     'Travel Agency Interest'}
                  </h2>
              ...
              <div className="p-6 space-y-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="sm:col-span-2">
                        ...
                        <input
                          ...
                          placeholder={`Enter ${form.type === 'hospital' ? 'hospital or clinic' : form.type === 'hotel' ? 'hotel or resort' : 'travel agency'} name`}
                ...
                {step === 2 && (
                  <>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1.5">Notes / Questions</label>
                      <textarea
                        value={form.notes}
                ...
                {step === 0 && (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Select Partnership Type</h3>
                    <p className="text-gray-500 mb-6">
                      Choose the organization type that best describes you.
                    </p>
                      ...
                      {partnerTypes.map((pt) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span className="text-sm font-medium text-gray-600 group-hover:text-care-700">{pt.label}</span>
                          </button>
                        );
                      })}
                    </div>
